    ...
    <div className={className} {...rest}>
      <Grid container spacing={isMd ? 4 : 2}>
        ...
        <Grid item xs={12} md={6} data-aos="fade-up">
          ...
          >
            <SectionHeader
              label="About RocketCyber SOC Services"
              title="Comprehensive protection, automatic backup, restore and reporting."
              subtitle="Instantly grow your security stack and augment your existing staff by partnering with RocketCyber's dedicated SOC team. Gain one step ahead of attackers by hiring veterans who've been on the forefront of investigating cyber threats."
              align="left"
              disableGutter
            />
